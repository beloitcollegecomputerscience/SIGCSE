...
if (SYSTEM_LIVE) {
	...
	// Fixed time errors on UBC, must reset every year.
	// TODO: check correct solution to timezone.
	// Okay for 2016 in Memphis.
	date_default_timezone_set('America/Chicago');
	define('SYSTEM_EMAIL_ADDRESS', 'sigcse2016-volunteers@bw.edu');
	...
	if (SYSTEM_TESTING) {
		...
		define('SYSTEM_WEB_BASE_ADDRESS', 'https://144.89.59.24/~sigcse/project/');
...
define('SIGCSE_HOME_PAGE', "http://sigcse2016.sigcse.org/");
define('SIGCSE_VOL_PAGE', "http://sigcse2016.sigcse.org/students/volunteers.html");
...
function toDo($string) {
	if (DISPLAY_TODOS) {
	?>
		<div class="alert alert-info"><span class="glyphicon glyphicon-hand-right"></span> <?php echo $string; ?></div>
	<?php
	}
}
