...
<!-- heading -->
					<div class="text-center">
						<h3 class="center-text"> Add Activity</h3>
					</div>
...
<div class="form-group" id="other_activity_type_form" style="display:none;">
							...
							<div class="col-lg-7">
							<label> input new type:
								<input type="text" class="form-control" id="other_activity_type"
									name="other_activity_type"
									> <span id="other_activity_type_result" style="display: none">duplicate type name, change name or select from the list</span></label>
							</div>
						</div>
...
<?php
 ...
 <option value="Other">Other</option>
			...
			<div class="form-group" id="other_activity_location_form" style="display:none">
							...
							<div class="col-lg-7">
							<label> input new location:
								<input type="text" class="form-control" id="other_activity_location"
									name="other_activity_location"
									> <span id="other_activity_location_result" style="display: none">duplicate room name, change name or select from the list</span></label>
							</div>
						</div>
...
<!-- dropdown list for organizer -->
 ...
 <option value="Other">Other</option>
 			 	...
 			 	<div class="form-group" id="other_activity_organizer_form" style="display:none">
							...
							<div class="col-lg-7">
							<label> input new organizer first name:
								<input type="text" class="form-control" id="other_activity_organizer_first"
									name="other_activity_organizer_first" ></label>
								<label> input new organizer last name: <input type="text" class="form-control" id="other_activity_organizer_last"
									name="other_activity_organizer_last"
									><span id="other_activity_organizer_result" style="display: none">duplicate organizer name, change name or select from list</span></label>
							</div>
						</div>
...
<!-- start time and end time. Havent down. right now just number input but has to be changed -->
 ...
 <div class="input-group date form_date col-md-9"  data-date-format="yyyy-mm-dd  hh:ii:00" >
                    <input class="form-control"  type="datetime" readonly id="activity_start_time">
 ...
 <div class="input-group date form_date col-md-9"  data-date-format="yyyy-mm-dd  hh:ii:00" >
                    <input class="form-control"  type="datetime" readonly id="activity_end_time">
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
					<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
	...
	<!-- these are just input numbers -->
				...
				style="color: red;">*</span></label>
							<div class="col-lg-7">
								<input type="number" min=0 class="form-control" id="min_num"
									name="min_num"
									>
							</div>
						</div>
				...
				style="color: red;">*</span></label>
							<div class="col-lg-7">
								<input type="number" min =0 class="form-control" id="desired_num"
									name="desired_num"
									>
							</div>
						</div>
				...
				style="color: red;">*</span></label>
							<div class="col-lg-7">
								<input type="number" min=0 class="form-control" id="max_num"
									name="max_num"
									>
							</div>
						</div>
